            ...
            return build_agent_output(
                {
                    ...
                    "financial_summary": {
                        ...
                        "interest_expense_source_account": ratios.get("interest_expense_source_account"),
                        "interest_expense_quality": ratios.get("interest_expense_quality"),
                        "interest_ratio_estimated": ratios.get("interest_ratio_estimated"),
                        "interest_ratio_note": ratios.get("interest_ratio_note"),
